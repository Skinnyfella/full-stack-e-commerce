...
RETURNS TRIGGER AS $$
DECLARE
    admin_email TEXT := 'toyinboayanfedavid@gmail.com'; -- Your admin email
BEGIN
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE email = 'toyinboayanfedavid@gmail.com'
    ) THEN
        -- Note: You'll need to manually create the admin user through registration first
